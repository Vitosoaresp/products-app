...
import { AuthMeResponse, AuthRegisterDto, AuthSignInDto, AuthSignInResponse } from "./auth.schema";
...
export class AuthController {
  ...
  @Post('signin')
  @ApiResponse({ status: 200, description: "User signed in", type: AuthSignInResponse })
